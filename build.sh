...
ld -m elf_i386 -T ./src/link.ld -o ./bin/koa.bin ./bin/kasm.o ./bin/kc.o ./bin/obj/system.o ./bin/obj/string.o ./bin/obj/screen.o ./bin/obj/kb.o ./bin/obj/idt.o ./bin/obj/util.o
